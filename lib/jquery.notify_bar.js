...
jQuery.notifyBar = function(settings) {
  ...
  (function($) {
    ...
    notifyBarNS.close = settings.close || false;
      ...
      //close button
    notifyBarNS.waitSignal = settings.waitSignal || false;

    //close button
    notifyBarNS.closeOnClick = settings.closeOnClick || true;
